...
const EditListing = ({ id }) => {
    ...
    const handleAdListingChange = (e) => {
        ...
        setAdListingDetails((prevDetails) => {
            ...
            // Reset discounted price if it's higher than the new price or price is cleared
            if (name === 'price') {
                if (value === '' || updatedDetails.discounted_price > Number(value)) {
    ...
    const editAd = async () => {
        ...
        const allData = {
            ...
            discounted_price: AdListingDetails.discounted_price,
    ...
    const getSingleListingData = async () => {
        try {
            ...
            setAdListingDetails((prevState) => ({
                ...
                discounted_price: listingData?.discounted_price || '',
