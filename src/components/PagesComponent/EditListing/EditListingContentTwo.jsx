            ...
            <div className="col-12">
                <div className="row formWrapper">
                    ...
                    <div className="col-12">
                        ...
                        <input placeholder={placeholderLabel} value={AdListingDetails.price} name='price' className={`${AdListingDetails.price !== '' ? 'bg' : ''}`} type='number' min="0" onChange={handleAdListingChange} required />
                    </div>
